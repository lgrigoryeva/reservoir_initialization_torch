...
class GeometricHarmonicsInterpolator(NDInterpolatorBase):
    ...
    def __init__(
        ...
        NDInterpolatorBase.__init__(self, points, values, need_contiguous=False, need_values=True)
        ...
        if diffusion_maps:
            ...
            self.diffusion_maps = DiffusionMaps(self.points, epsilon, **diffusion_maps_options)
    ...
    def __call__(self, *args):
        ...
        distance_matrix = kdtree.sparse_distance_matrix(dmaps_kdtree, radius, output_type="coo_matrix")
    ...
    def gradient(self, *args):
        ...
        ew = self.diffusion_maps.eigenvalues
        ev = self.diffusion_maps.eigenvectors
        epsilon = self.diffusion_maps.epsilon
