...
dneupd_messages = dict(
    [
        ...
        (
            -8,
            "Error return from calculation of a real Schur form. " "Informational error from LAPACK routine dlahqr.",
        ),
        (
            -9,
...
def eigensolver(
    ...
    logging.debug("Done with Arnoldi iteration after {} steps. " "Elapsed time: {} seconds".format(itr, clk))
